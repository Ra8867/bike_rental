...
<a href="manage-bookings.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Cancel this Booking')"> Cancel</a>
         ...
         <td> <a href="send_notice.php?id=<?php echo htmlentities($result->id);?>&rdate=<?php echo htmlentities($result->ToDate);?>&email=<?php echo htmlentities($result->EmailId);?>"> send notice </a> </td>
