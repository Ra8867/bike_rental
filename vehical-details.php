...
if($todate<$fromdate)
{
echo "<script>alert('To Date must be greater than From Date.');document.location='vehical-details.php?vhid=4'</script>";
}
...
$_SESSION['bid']=$lastInsertId;
if($lastInsertId)
{
echo "<script>alert('Booking successfull.');document.location='adv_payment.php'</script>";
}
else
{
